...
const AttendeeDetails = () => {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-[#041E23] text-white rounded-2xl border-[1px] border-[#197686]">
    ...
    <div className="max-w-lg mx-auto p-6 bg-[#08252B] text-white rounded-2xl border border-[#197686]">
      <div className="bg-[#052228] p-6 border border-[#07373F] rounded-2xl">
      <h2 className="text-sm font-semibold mb-4">Upload Profile Photo</h2>
      {/* Image Upload Box */}
      <div className="bg-[#041E23] px-20 h-40 flex justify-center">
      <span
        {...getRootProps()}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Buttons */}
        <div className="JejuMyeongjo text-sm flex justify-between mt-4">
            <button
              className="cursor-pointer w-[48%] bg-transparent border-[1px] border-[#24A0B5] text-[#24A0B5] py-2 rounded-lg hover:bg-[#197686] hover:text-white"
              onClick={(e) => {
                e.preventDefault();
                navigate("/");
              }}
